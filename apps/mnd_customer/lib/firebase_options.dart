...
// Copy `appId` from the `firebaseConfig` / `const firebaseConfig` snippet into [web] below.
...
class DefaultFirebaseOptions {
  ...
  /// Web app must exist in Firebase (same project). Replace [appId] if you see
  /// `key=REPLACE_ME` or reCAPTCHA 400 errors in the browser console.
  ...
  /// Add an iOS app in Firebase and paste values from `GoogleService-Info.plist`.
  static const FirebaseOptions ios = FirebaseOptions(
    ...
    projectId: 'masterndelivery-3cb92',
    storageBucket: 'masterndelivery-3cb92.firebasestorage.app',
    iosBundleId: 'com.mnd.delivery.mndCustomer',
  );
}
